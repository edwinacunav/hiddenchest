...
public:
  enum ButtonCode
  {
    None = 0,// Down = 2, Left = 4, Right = 6, Up = 8,
    ...
    Equals = 46, LeftBracket = 47, RightBracket = 48, BackSlash = 49, NonUSHash = 50,
    Semicolon = 51, Apostrophe = 52, Grave = 53, Comma = 54, Period = 55, Slash = 56,
    CapsLock = 57, F3 = 60, F4 = 61, F5 = 62, F6 = 63, F7 = 64, F8 = 65, F9 = 66,//Void1 = 0, Void2 = 0, 
    F10 = 67, F11 = 68, F12 = 69, PrintScreen = 70, ScrollLock = 71, Pause = 72,
    Insert = 73, Home = 74, PageUp = 75, Delete = 76, End = 77, PageDown = 78,
    ArrowRight = 79, ArrowLeft = 80, ArrowDown = 81, ArrowUp = 82,
    NumPadDivide = 84, NumPadMultiply = 85, NumPadMinus = 86, NumPadPlus = 87,
    Enter = 88, NumPad1 = 89, NumPad2 = 90, NumPad3 = 91, NumPad4 = 92,
    NumPad5 = 93, NumPad6 = 94, NumPad7 = 95, NumPad8 = 96, NumPad9 = 97, NumPad0 = 98,
    NumPadDot = 99, LessOrGreater = 100, APP = 101, KeyPower = 102, NumPadEquals = 103,
    ...
    MouseWheelUp = 293, MouseWheelDown = 294,
    Down = 295, Left = 296, Right = 297, Up = 298,
    A = 299, B = 300, C = 301, X = 302, Y = 303, Z = 304,
    L = 305, R = 306, Shift = 307, Ctrl = 308, Alt = 309
  };
  void update();
...
private:
  ...
  InputPrivate *p; /*struct SomeButton; struct SomeButton button;*/
  int repeat_count = 0;
};
