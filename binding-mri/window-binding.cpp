...
void windowBindingInit()
{
  ...
  _rb_define_method(klass, "initialize", window_initialize);
  rb_define_method(klass, "update", RUBY_METHOD_FUNC(window_update), 0);
  rb_define_method(klass, "windowskin", RUBY_METHOD_FUNC(window_get_windowskin), 0);
  rb_define_method(klass, "windowskin=", RUBY_METHOD_FUNC(window_set_windowskin), 1);
